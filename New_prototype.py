...
def main_page():
	...
	l = tk.Label(main,text='Eastern')    # 标签的文字bg='green',     # 背景颜色font=('Arial', 12),     # 字体和字体大小width=15, height=2  # 标签长宽)
	l.pack()    # 固定窗口位置
...
def usr_sign_up():
    ...
    entry_live_region = tk.Entry(window_sign_up, textvariable=new_live_region)
